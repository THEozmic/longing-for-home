<template>
  <div @wheel="localScroll">
    <div class="embed-container">
      <iframe
        src="https://player.vimeo.com/video/345950179?background=0&autoplay=0&loop=1"
        frameborder="0"
...
import AUDIO from "../assets/audios/RELIGION_TEMP_MUSIC.wav";
...
export default {
  ...
  mounted() {
    let iframe = document.querySelector("#page-26-iframe");
